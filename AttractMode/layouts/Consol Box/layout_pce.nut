...
fe.add_image( "consol_pce.png", 150, 818, 646, 257);
...
{
	local boximage = fe.add_artwork("cartridge_disc",655, 730, 400, 330 );
...
{
	local boximage2 = fe.add_artwork("3dbox",655, 730, 400, 330 );
