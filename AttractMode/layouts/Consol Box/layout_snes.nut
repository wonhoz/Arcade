...
fe.add_image( "consol_snes.png", 100, 820, 560, 249);
...
{
	local boximage = fe.add_artwork("cartridge_disc",685, 800, 275, 275 );
...
{
	local boximage2 = fe.add_artwork("3dbox",685, 800, 275, 275 );
