...
// 모니터와 콘솔기기
fe.add_image( "monitor_gba.png", 43, 99, 900, 512);
fe.add_image( "consol_gba.png", 97,670, 840, 358);

// 동영상
local snap = fe.add_artwork( "snap", 295, 216, 398, 252 );
//snap.preserve_aspect_ratio = true;
snap.trigger = Transition.EndNavigation;
// fe.add_image( "scanline.png", 295, 216, 398, 252);
...
::OBJECTS <- {
 marquee = fe.add_artwork( "marquee", 315, 20, 360, 120 ),
}
