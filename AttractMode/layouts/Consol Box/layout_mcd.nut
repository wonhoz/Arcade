...
fe.add_image( "consol_mcd.png", 130, 800, 565, 268);

// 동영상
local snap = fe.add_artwork( "snap", 123, 151, 706, 529 );
...
// 게임선택 박스
fe.add_image("box_blue.png", 1007, 548, 856, 80 );
...
{
	local boximage = fe.add_artwork("cartridge_disc",700, 770, 260, 290 );
...
{
	local boximage2 = fe.add_artwork("3dbox",700, 770, 260, 290 );
