...
fe.add_image( "consol_sms.png", 210, 840, 484, 232);
...
{
	local boximage = fe.add_artwork("cartridge_disc",695, 720, 280, 350 );
...
{
	local boximage2 = fe.add_artwork("3dbox",695, 720, 280, 350 );
