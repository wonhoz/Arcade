...
fe.add_image( "consol_NEC_PC-FX.png", 230, 740, 427, 336);
...
{
	local boximage = fe.add_artwork("cartridge_disc",680, 775, 280, 280 );
...
{
	local boximage2 = fe.add_artwork("3dbox",680, 775, 280, 280 );
