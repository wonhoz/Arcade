...
if ( my_config["select_bgArt_ps1"] == "video1" ){
bgArt = fe.add_artwork("bg_01.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video2" ){
bgArt = fe.add_artwork("bg_02.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video3" ){
bgArt = fe.add_artwork("bg_03.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video4" ){
bgArt = fe.add_artwork("bg_04.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video5" ){
bgArt = fe.add_artwork("bg_05.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video6" ){
bgArt = fe.add_artwork("bg_06.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video7" ){
bgArt = fe.add_artwork("bg_07.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video8" ){
bgArt = fe.add_artwork("bg_08.mp4", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "video9" ){
bgArt = fe.add_artwork("bg_09.mp4", 0, 0, flw, flh );
}

if ( my_config["select_bgArt_ps1"] == "gif1" ){
bgArt = fe.add_artwork("bg_01.gif", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "gif2" ){
bgArt = fe.add_artwork("bg_02.gif", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "gif3" ){
bgArt = fe.add_artwork("bg_03.gif", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "gif4" ){
bgArt = fe.add_artwork("bg_04.gif", 0, 0, flw, flh );
}
if ( my_config["select_bgArt_ps1"] == "gif5" ){
bgArt = fe.add_artwork("bg_05.gif", 0, 0, flw, flh );
}

bgArt = fe.add_image("bg_" + my_config["select_bgArt_ps1"] + ".png", 0, 0, flw, flh );
...
fe.add_image( "consol_ps1.png", 180, 830, 537, 238);
