...
fe.add_image( "consol_ps2.png", 130, 830, 625, 242);
...
{
	local boximage = fe.add_artwork("cartridge_disc",705, 735, 280, 330 );
...
{
	local boximage2 = fe.add_artwork("3dbox",705, 735, 280, 330 );
