...
fe.add_image( "consol_nes.png", 140, 795, 595, 271);
...
{
	local boximage = fe.add_artwork("cartridge_disc",695, 812, 280, 233 );
...
{
	local boximage2 = fe.add_artwork("3dbox",695, 812, 280, 233 );
