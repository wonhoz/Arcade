...
// version 1.1 Renovated by CSOne in 2018.11.08
// 
...
//-----------------------------------------------------------------
</ label="spinwheel artwork", help="marquee or wheel", options="marquee,wheel,listbox", order=12 /> spinwheelArt="listbox";
...
</ label="background ststic image", help="background image if there is no background art", options="blue,blue2,gray,gray2,green,green2,orange,red,pink,purple,purple2,retro,user1,user2,user3,none", order=16 /> enable_static_bkg="gray";
</ label="background mask", help="make background medium or dark", options="dark,medium,none", order=17 /> enable_mask="dark";
...
fe.layout.font="texgyreheros-bold";
...
local bgArt = fe.add_image("bg_" + my_config["enable_static_bkg"] + ".png", 0, 0, flw, flh );
...
local titleText = fe.add_text( "[Title]", flx*0.31, fly*0.28, flw*0.6, flh*0.027  );
titleText.align = Align.Left;
titleText.set_rgb(255,255,255);
titleText.font = "NanumBarunGothicBold";

local titleText = fe.add_text( "© [Year] [Manufacturer]", flx*0.31, fly*0.325, flw*0.6, flh*0.027  );
titleText.align = Align.Left;
titleText.set_rgb(170,220,240);
titleText.font = "NanumBarunGothicBold";

local titleText = fe.add_text( "[Category]", flx*0.312, fly*0.360, flw*0.6, flh*0.027  );
titleText.align = Align.Left;
titleText.set_rgb(170,220,240);
titleText.font = "NanumBarunGothicBold";
...
{
// 게임 리스트 배경
local listbg = fe.add_artwork("list_bg.png",1020, 20, 870, 1046 );
listbg.alpha = 150;

// 에뮬 디스플레이 타이틀
local displayName = fe.add_image ("Display/[DisplayName]",1090, 24, 750, 200);


// 리스트 게임번호 그림자
local listbox1b = fe.add_listbox( 1040, 230, 345, 730 );
...
// 리스트 박스 게임번호
local listbox1 = fe.add_listbox( 1037, 227, 345, 730 );
...
// 리스트 박스 게임이름 그림자
local listbox2b = fe.add_listbox( 1140, 223, 720, 730 );
listbox2b.charsize = 40;
...
// 리스트 박스 게임이름
local listbox2 = fe.add_listbox( 1137, 220, 720, 730 );
listbox2.charsize = 40;
...
// 게임선택 박스
fe.add_image("box.png", 1027, 548, 856, 80 );

// 시계
local clockbtext = fe.add_text( "TIME:", 990, 1004, 200, 46 );
clockbtext.set_rgb( 0, 0, 0 );
clockbtext.font="Ticketbook W01 Bold";

local clocktext = fe.add_text( "TIME:", 987, 1001, 200, 46 );
clocktext.set_rgb( 211, 250, 255 );
clocktext.font="Ticketbook W01 Bold";

local clockb = fe.add_text( "", 1160, 1009, 320, 46  );
clockb.align = Align.Left;
clockb.set_rgb( 0, 0, 0 );

local clock = fe.add_text( "", 1157, 1006, 320, 46  );
...
// 즐겨찾기 필터
local listtextb = fe.add_text( "[!filter] GAMES:", 1360, 1004, 450, 46 );
listtextb.set_rgb( 0, 0, 0 );
listtextb.font="Ticketbook W01 Bold";
listtextb.align = Align.Left;

local listtext = fe.add_text( "[!filter] GAMES:", 1357, 1001, 450, 46 );
...
local listb = fe.add_text("[ListSize]", 1730, 1009, 200, 46 );
listb.set_rgb( 0, 0, 0 );
listb.align = Align.Left;

local list = fe.add_text( "[ListSize]", 1727, 1006, 200, 46 );
