...
if ( my_config["enable_static_bkg3"] == "none") 
{
 local bg = fe.add_image( "", 0, 0, flw, flh );
}

local bgArt = fe.add_image("bg_" + my_config["enable_static_bkg3"] + ".png", 0, 0, flw, flh );
...
local tvStatic = fe.add_image( "static.jpg", blip*0.1661, blip*0.300, blip*0.5928, blip*0.452);
...
local cabScreen = fe.add_artwork ("snap", blip*0.1661, blip*0.300, blip*0.5928, blip*0.452);
...
{
local scanlines = fe.add_image( "scanlines.png", blip*0.1661, blip*0.300, blip*0.5928, blip*0.452 );
...
{
local marqueeBkg0 = fe.add_image("blank-marquee.png", blip*0.0324, blip*0.0, blip*0.874, blip*0.24 );
local marqueeBkg = fe.add_image("[marquee]", blip*0.0324, blip*0.0, blip*0.874, blip*0.24 );
...
local marquee = FadeArt("marquee", blip*0.0324, blip*0.0, blip*0.874, blip*0.24 );
...
//cabinet image -------------------------------------- START
local cab = fe.add_image( "cab_body_mvs.png", 0, 0, blip*0.992, blip*1.008);
