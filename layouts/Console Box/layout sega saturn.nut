...
{
	local boximage = fe.add_artwork( "cartridge", 0.304*flw, 0.661*flh, 0.146*flw, 0.259*flh );
...
{
	local boximage2 = fe.add_artwork( "3dbox", 0.304*flw, 0.661*flh, 0.146*flw, 0.259*flh );
