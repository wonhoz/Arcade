...
{
	local boximage = fe.add_artwork( "cartridge", 0.367*flw, 0.605*flh, 0.146*flw, 0.306*flh );
...
{
	local boximage2 = fe.add_artwork( "3dbox", 0.367*flw, 0.605*flh, 0.146*flw, 0.306*flh );
