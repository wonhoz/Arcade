...
// image animation
local bgArt1 = fe.add_image("background/gray.png", 0, 0, flw, flh );
...
fe.add_image("system/[DisplayName].png", 0.048*flw, 0.677*flh, 0.28*flw, 0.22*flh );
...
{
	local boximage = fe.add_artwork( "cartridge", 0.354*flw, 0.661*flh, 0.146*flw, 0.259*flh );
...
{
	local boximage2 = fe.add_artwork( "3dbox", 0.354*flw, 0.661*flh, 0.146*flw, 0.259*flh );
