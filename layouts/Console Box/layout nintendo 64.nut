...
{
	local boximage = fe.add_artwork( "cartridge", 0.354*flw, 0.672*flh, 0.146*flw, 0.259*flh );
...
{
	local boximage2 = fe.add_artwork( "3dbox", 0.354*flw, 0.672*flh, 0.146*flw, 0.259*flh );
