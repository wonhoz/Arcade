...
fe.add_image("system/[DisplayName].png", 0.048*flw, 0.652*flh, 0.271*flw, 0.258*flh );
...
{
	local boximage = fe.add_artwork( "cartridge", 0.334*flw, 0.672*flh, 0.1752*flw, 0.259*flh );
...
{
	local boximage2 = fe.add_artwork( "3dbox", 0.334*flw, 0.672*flh, 0.1752*flw, 0.259*flh );
