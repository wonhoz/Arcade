...
local tvStatic = fe.add_image( "static.jpg", blip*0.128+20, blip*0.302+55, blip*0.646-332, blip*0.480-227);
...
local cabScreen = fe.add_artwork ("snap", blip*0.128+30, blip*0.302+65, blip*0.646-352, blip*0.480-247);
...
{
local scanlines = fe.add_image( "scanlines.png", blip*0.128+30, blip*0.302+65, blip*0.646-352, blip*0.480-247 );
...
{
local marqueeBkg0 = fe.add_image("static.jpg", blip*0.0639+2, blip*0.0037+73, blip*0.774-294, blip*0.206-108 );
local marqueeBkg = fe.add_image("[marquee]", blip*0.0639+2, blip*0.0037+73, blip*0.774-294, blip*0.206-108 );
...
local marquee = FadeArt("marquee", blip*0.0639+2, blip*0.0037+73, blip*0.774-294, blip*0.206-108 );
...
//local lcdLeftText1 = fe.add_text( "PLAYED: " + "[PlayedCount]", blip*0.528, blip*0.2378+52, blip*0.231, blip*0.04 );  // here you can change what is displayed on left side
local lcdLeftText2 = fe.add_text( "YEAR: " + "[Year]", blip*0.1621-51, blip*0.2378+52, blip*0.231, blip*0.04 );
...
{
local lcdRightText = fe.add_text( "[FilterName]", blip*0.345, blip*0.2378+52, blip*0.231, blip*0.04 );
...
{
local lcdRightText = fe.add_text( "[Name]", blip*0.345, blip*0.2378+52, blip*0.231, blip*0.04 );
lcdRightText.set_rgb( 170, 220, 240);
lcdRightText.align = Align.Centre;
// lcdRightText.rotation = -6.6;
lcdRightText.font="digital-7 (italic)";  // free font (for personal use) - can be downloaded here: http://www.dafont.com/digital-7.font
...
{
local lcdRightText = fe.add_text( "[DisplayName]", blip*0.345, blip*0.2378+52, blip*0.231, blip*0.04 );
lcdRightText.set_rgb( 170, 220, 240);
lcdRightText.align = Align.Centre;
// lcdRightText.rotation = -6.6;
lcdRightText.font="digital-7 (italic)";  // free font (for personal use) - can be downloaded here: http://www.dafont.com/digital-7.font
...
{
local lcdRightText = fe.add_text( "[Emulator]", blip*0.345, blip*0.2378+52, blip*0.231, blip*0.04 );
lcdRightText.set_rgb( 170, 220, 240);
lcdRightText.align = Align.Centre;
// lcdRightText.rotation = -6.6;
lcdRightText.font="digital-7 (italic)";  // free font (for personal use) - can be downloaded here: http://www.dafont.com/digital-7.font
...
{
local lcdRightText = fe.add_text( my_config["lcdRightText"], blip*0.345, blip*0.2378+52, blip*0.231, blip*0.04 );
lcdRightText.set_rgb( 170, 220, 240);
lcdRightText.align = Align.Centre;
// lcdRightText.rotation = -6.6;
lcdRightText.font="digital-7 (italic)";  // free font (for personal use) - can be downloaded here: http://www.dafont.com/digital-7.font
...
local titleText = fe.add_text( "[Title]", flx*0.07313+57, fly*0.7991-175, flw*0.307, flh*0.024  );
