...
//cabinet image -------------------------------------- START
local cab = fe.add_image( "cab_body_red.png", 0, 0, blip*0.992, blip*1.008);
...
// 리스트 박스 게임이름 그림자
local listbox2b = fe.add_listbox( flw*0.59375, flh*0.2064815, flw*0.375, flh*0.6759259 );
...
// 리스트 박스 게임이름
local listbox2 = fe.add_listbox( flw*0.5921875, flh*0.2037037, flw*0.375, flh*0.6759259 );
