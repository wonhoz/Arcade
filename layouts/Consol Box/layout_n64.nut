...
fe.add_image( "consol_n64.png", 140, 800, 521, 279);
...
{
	local boximage = fe.add_artwork("cartridge_disc",680, 790, 280, 280 );
...
{
	local boximage2 = fe.add_artwork("3dbox",680, 790, 280, 280 );
