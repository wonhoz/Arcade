...
// image animation
local bgArt1 = fe.add_image("background/blue.png", 0, 0, flw, flh );
...
//cabinet image -------------------------------------- START
local cab = fe.add_image( "cabinet/vewlix_blue.png", 0, 0, blip*0.955, blip*0.992);
...
//cabinet image -------------------------------------- START
// local cab = fe.add_image( "cabinet/vewlix_blue.png", 0, 0, blip*0.992, blip*1.008);
// cab.preserve_aspect_ratio = true;
