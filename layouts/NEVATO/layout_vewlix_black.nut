...
// image animation
local bgArt1 = fe.add_image("background/black.png", 0, 0, flw, flh );
...
//cabinet image -------------------------------------- START
local cab = fe.add_image( "cabinet/vewlix_black.png", 0, 0, blip*0.955, blip*0.992);
...
if ( my_config["marquee_type"] == "marquee" )
{
    ...
    local marqueeBkg = fe.add_image("[wheel]", blip*0.18796, blip*0.05648, blip*0.57685, blip*0.10000 );
    ...
    local marquee = FadeArt("wheel", blip*0.18796, blip*0.05648, blip*0.57685, blip*0.10000 );
...
//cabinet image -------------------------------------- START
// local cab = fe.add_image( "cabinet/vewlix_black.png", 0, 0, blip*0.992, blip*1.008);
// cab.preserve_aspect_ratio = true;
...
local info_db = fe.add_text( "개발사: [Manufacturer]   |   발매년도: [Year]   |   장르: [Category]   |   [Players]인용", 0.10154*flw, 0.29584*flh, 0.334*flw, flh*0.019 );
