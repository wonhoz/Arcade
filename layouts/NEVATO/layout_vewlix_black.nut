...
//cabinet image -------------------------------------- START
local cab = fe.add_image( "cabinet/vewlix_black.png", 0, 0, blip*0.674, blip*0.992);
...
if ( my_config["marquee_type"] == "marquee" )
{
    ...
    local marqueeBkg = fe.add_image("[wheel]", blip*0.12988, blip*0.05371, blip*0.40918, blip*0.10254 );
    ...
    local marquee = FadeArt("wheel", blip*0.12988, blip*0.05371, blip*0.40918, blip*0.10254 );
