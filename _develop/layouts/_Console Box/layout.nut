...
class UserConfig
{
    ...
    //-----------------------------------------------------------------
    </ label="배경 영상", help="배경 영상을 선택하세요.", options="black,gray,red,orange,green,cyan,blue,purple,violet,dot,drop,dust,square,none", order=6 /> select_bkg="blue";
    ...
    </ label="캐릭터 투명도", help="0 (투명) 에서 254 (불투명) 사이의 값을 입력하세요.", options="", order=10 /> select_Alpha="254";
    ...
    </ label="아트웍 영상 선택", help="선택된 아트웍 영상이 콘솔 시스템 오른쪽에 표시됩니다.", options="Cartridge_Disc,3D Box,None", order=16 /> enable_boximage="cartridge_disc";
