...
</ label="Select Artwork Image", help="Selected Artwork Image is displayed at the right of console game machine.", options="Cartridge_Disc,3D Box,None", order=27 /> enable_boximage="cartridge_disc";
}  
...
fe.add_image(  "console_pcecd.png", 0.036*flw, 0.764*flh, 0.341*flw, 0.22*flh );
