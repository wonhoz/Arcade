...
fe.add_image("system/[DisplayName].png", 0.073*flw, 0.741*flh, 0.271*flw, 0.258*flh );
...
{
	local boximage = fe.add_artwork( "cartridge_disc", 0.354*flw, 0.731*flh, 0.146*flw, 0.259*flh );
...
{
	local boximage2 = fe.add_artwork( "3dbox", 0.354*flw, 0.731*flh, 0.146*flw, 0.259*flh );
