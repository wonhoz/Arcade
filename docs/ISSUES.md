...
**진행 현황** — 처리 **88건** / 미해결 **2건**(13 · 65번) · 보류 3건(1 · 2 · 70번) · 재분류 3건(11 · 14 · 27번) · 개선 포인트 8건 — 7차 재점검 2026-09-13
...
> 남은 큰 몫은 `IDZ` 의 종료 21초다 — ESC 가 안 먹는 에뮬레이터를 기억하는 `$script:EscFail` 이 실행마다 비어서 매번 사다리를 오른다.
