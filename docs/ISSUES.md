...
**진행 현황** — 처리 **73건** / 미해결 **2건**(13 · 65번) · 보류 3건(1 · 2 · 70번) · 재분류 3건(11 · 14 · 27번) · 개선 포인트 8건 — 5차 재점검 2026-09-08~09
...
| 아이디어 | 예상 효과 | 걸리는 것 |
|---|---|---|
| **증분 점검** — 에뮬레이터 cfg·실행파일·롬·romlist 줄이 지난 정상 보고서와 같으면 건너뛴다 | 평소 점검이 **수 분** | 입력 해시를 보고서에 같이 저장해야 한다. **일상 점검에는 이게 가장 크다** |
