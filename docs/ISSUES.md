...
**진행 현황** — 처리 **34건** / 미해결 **6건**(13번, 37~41번) · 보류 2건 · 재분류 3건 · 개선 포인트 8건
(28~36번은 2026-09-04에 항목별로 한 커밋씩 처리. 37~41번은 4차 재점검이 3차 처리분을 재검증해 찾은 것)
...
### - [ ] 37. MAME Adult 마스코트 — 컷아웃이지만 허리 아래가 **직선으로 잘려** 있다
...
### - [ ] 38. Sammy Atomiswave 마스코트 — 무릎에서 잘려 캔버스 바닥에 닿아 있다 (2022년부터)
